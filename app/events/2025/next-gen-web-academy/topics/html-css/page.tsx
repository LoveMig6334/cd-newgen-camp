...
export default function HtmlCss() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-yellow-50 to-white">
      ...
      <div className="relative bg-linear-to-br from-blue-500 to-blue-600 overflow-hidden">
  ...
  margin-bottom: 15px;
        ...
        {activeSection === "topics" && (
          ...
          >
            ...
            <div className="mt-8 p-5 bg-linear-to-r from-yellow-100 to-yellow-50 rounded-xl">
              <h3 className="font-bold text-lg mb-3 text-gray-800">
        ...
        {activeSection === "frameworks" && (
          ...
          >
            ...
            <div className="bg-linear-to-br from-yellow-200 to-yellow-100 p-5 rounded-xl">
              <h3 className="font-bold text-lg mb-3 text-gray-800">
                ในค่าย CDSC
              </h3>
              <p>
