...
export default function FigmaBasics() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-blue-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
              ...
              <div className="mt-8">
                ...
                <div className="bg-blue-50 p-4 rounded-xl border border-blue-100">
                  <ol className="space-y-3">
                    <li className="flex items-start">
                      <span className="bg-blue-200 text-blue-800 rounded-full w-6 h-6 flex items-center justify-center mr-2 shrink-0">
                        1
                      </span>
                      <div>
        ...
        {activeSection === "tools" && (
          ...
          >
            ...
            <div className="mt-8 p-5 bg-linear-to-r from-blue-100 to-blue-50 rounded-xl">
        ...
        {activeSection === "responsive" && (
          ...
          >
            ...
            <div className="bg-linear-to-br from-blue-200 to-blue-100 p-5 rounded-xl">
              <h3 className="font-bold text-lg mb-3 text-gray-800">
        ...
        {activeSection === "activities" && (
          ...
          >
            ...
            <div className="mt-8 bg-linear-to-br from-blue-200 to-blue-100 p-5 rounded-xl">
      ...
      <div className="bg-linear-to-t from-blue-50 to-transparent py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white/70 backdrop-blur-md rounded-2xl p-6 border border-blue-200 shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Link
                href="/events/2025/next-gen-web-academy/topics/design-thinking"
